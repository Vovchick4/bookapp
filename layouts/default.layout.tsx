...
export default function DefaultLayout() {
  ...
  const {
    queryRoom: { refetch, isLoading, isRefetching },
    calendarViewType,
    currentInterval,
    openModal,
    onChangeView,
            ...
            options={{
              headerRight: () => (
                ...
                >
                  ...
                  >
                    <Menu.Item
                      onPress={() => onChangeView(ECalendarViewType.week)}
                      title="Week View"
                      leadingIcon={() => (
                        <MaterialCommunityIcons
                          name="calendar-week"
                          size={22}
                          color={
                            calendarViewType === ECalendarViewType.week
                              ? "red"
                              : "black"
                          }
                        />
                    ...
                    />
                    <Menu.Item
                      onPress={() => onChangeView(ECalendarViewType.month)}
                      title="Month View"
                      leadingIcon={() => (
                        <MaterialCommunityIcons
                          ...
                          size={22}
                          color={
                            calendarViewType === ECalendarViewType.month
                              ? "red"
                              : "black"
                          }
                        />
